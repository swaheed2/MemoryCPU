	...
	public static void processInstruction (int inst, int op, BufferedReader br) throws IOException {
		...
		switch (inst){
			...
			case 11:   //Add the value in Y to the AC
				AC += y;
				//printSToScreen("Add " + y + " in y to AC: " + AC);
				break;
			...
			case 21:   // Jump to the address only if the value in the AC is zero
				...
				printSToScreen("21. Jump to the address only if the value in the AC is zero...." + "AC: " + AC);
                break;
